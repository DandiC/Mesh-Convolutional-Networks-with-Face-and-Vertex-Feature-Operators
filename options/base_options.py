...
class BaseOptions:
    ...
    def initialize(self):
        ...
        # self.parser.add_argument('--arch', type=str, default='mconvnet', choices={"mconvnet", "meshunet", "meshGAN"}, help='selects network to use')
        ...
        # self.parser.add_argument('--name', type=str, default='shrec6_rawN', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--unpool_res', nargs='+', default=[8, 8], type=int,
